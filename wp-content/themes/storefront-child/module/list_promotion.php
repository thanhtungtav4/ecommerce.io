<div class="c-sure">
    <ul class="slick-sure">
        <li class="is_pointer" onclick="window.open('https://caraslens.com/chinh-sach-giao-nhan/')">
            <p><?php _e('Freeship within the city for orders <strong>from 250,000 VND</strong>– Province <strong>from 400.000 VND</strong>', 'storefront') ?></p>
            <picture>
        ...
        <li>
            <p><?php _e('Pay <strong>swipe the card on the spot </strong>(applied within Hanoi and HCMC)', 'storefront') ?></p>
            <picture>

<div class="m-product">
  <div class="m-product_top">
    <h4><?php _e('Related products', 'storefront') ?></h4>
...
<div class="m-product">
  <div class="m-product_top">
    <h4><?php _e('Buy together products', 'storefront') ?></h4>
    <div class="m-product__nav">
      <button class="m-product__prev">
        <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="23" cy="23" r="22" stroke-width="2"></circle>
  ...
  <div class="m-product__inner w-100">
    <ul class="m-item w-100">
      <?php
        if(get_field('list_product_together')){
          $args = array(
            'post_type'   => 'product',
            'post_status' => 'publish',
            'post__in' => get_field('list_product_together'),
          );
        }
        else{
          $args = array(

							...
							<div class="cart_content">
								<div class="cart_content_top">
									<a href="<?php echo $product_permalink ?>">
										...
										<?php if(get_field('product_attributes_color', $cart_item['product_id'] )) : ?>
											<p> <?php the_field('product_attributes_color', $cart_item['product_id'] ) ?></p>
										<?php endif; ?>
										<?php if(get_field('time_deo', $cart_item['product_id'] )) : ?>
											<p> <?php the_field('time_deo', $cart_item['product_id'] ) ?></p>
										<?php endif; ?>
									</a>
              		<div class="btn_area1">
										<?php

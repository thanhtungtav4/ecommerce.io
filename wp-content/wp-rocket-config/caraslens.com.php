...
$rocket_cookie_hash = 'b8f923ce925057ef5b4f6eaf40e0dcb6';
$rocket_logged_in_cookie = 'wordpress_logged_in_b8f923ce925057ef5b4f6eaf40e0dcb6';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 1;
$rocket_cache_reject_uri = '/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/en/checkout/(.*)|/thanh-toan/(.*)|/en/cart/|/gio-hang/|/en/my-account/(.*)|/tai-khoan/(.*)|/wc-api/v(.*)|/(index\.php/)?(.*)wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '647ff2cea6b1b020240204';
$rocket_cache_ssl = 1;

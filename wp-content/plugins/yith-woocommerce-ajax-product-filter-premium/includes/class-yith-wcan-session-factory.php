...
if ( ! class_exists( 'YITH_WCAN_Session_Factory' ) ) {
	...
	class YITH_WCAN_Session_Factory {
		...
		public static function get_session_query_var() {
			...
			return isset( $_REQUEST[ $param ] ) ? sanitize_text_field( wp_unslash( $_REQUEST[ $param ] ) ) : get_query_var( $param ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
		}

...
class Xoo_Helper{
	...
	public function get_outdated_section(){
		...
		<div class="xoo-outdatedtemplates">
			...
			<?php else: ?>
				...
				<a href="https://docs.xootix.com/<?php echo esc_attr( $this->slug ); ?>" target="_blank"><?php _e( 'How to override?', $this->slug ); ?></a>
				</div>
			<?php endif; ?>
	...
	public function time_to_update_theme_templates_data(){
		...
		if(  ( ( time() - $tempData['last_scanned'] ) > ( 86400 * 2 ) ) || ( isset( $_GET['scan_templates'] ) && isset( $_GET['slug'] ) && $_GET['slug'] === $this->slug ) ){

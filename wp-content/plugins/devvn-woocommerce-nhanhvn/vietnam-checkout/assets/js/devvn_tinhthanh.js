...
(function($) {
    ...
    $(document).ready(function () {
        ...
        $( document.body ).on( 'change refresh', '#billing_state, #calc_shipping_state', function() {
            ...
            let country     = $wrapper.find('#billing_country, #calc_shipping_country').val(),
        ...
        $( document.body ).on( 'change refresh', '#shipping_state', function() {
            ...
            let country     = $wrapper.find('#shipping_country, #calc_shipping_country').val(),

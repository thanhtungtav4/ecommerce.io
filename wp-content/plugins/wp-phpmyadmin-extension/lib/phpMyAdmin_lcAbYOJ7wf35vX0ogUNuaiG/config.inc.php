...
$cfg['blowfish_secret']					= 'i|G#1422]xnhJAe=TIafD.V+~7+O!=gp' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_lcAbYOJ7wf35vX0ogUNuaiG/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://dev.caraslens.com/wp-admin/?rand=47837557&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://dev.caraslens.com/wp-admin/?rand=83535841&pma_logout=1';

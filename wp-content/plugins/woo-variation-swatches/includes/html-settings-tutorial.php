...
<div id="woo-variation-swatches-tutorials-wrapper">
    ...
    <ul>
        <li>
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-1.png' ) ?>"></div>
        ...
        <li>
            ...
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-2.png' ) ?>"></div>
        </li>
        
        <li>
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-3.png' ) ?>"></div>
            <div class="tutorial-description-wrapper">
        ...
        <li>
            ...
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-4.png' ) ?>"></div>
        </li>
        
        
        <li>
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-5.png' ) ?>"></div>
            <div class="tutorial-description-wrapper">
                <h3>Text Tooltip</h3>
                <div class="tutorial-contents">
        ...
        <li>
            ...
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-6.png' ) ?>"></div>
        </li>
        <li>
        ...
        <li>
            ...
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-23.png' ) ?>"></div>
        </li>
        
        <li>
            <div class="tutorial-image-wrapper"><img alt="" src="<?php echo woo_variation_swatches()->org_assets_url( '/tutorial-24.png' ) ?>"></div>
            <div class="tutorial-description-wrapper">
